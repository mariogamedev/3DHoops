 ...
 */
    ...
    public class CustomThirdPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _input = GetComponent<BallerInputs>();
#if ENABLE_INPUT_SYSTEM
        ...
        private void Move()
        {
            ...
            BallerInputNotifications.MoveAction.Invoke(inputMagnitude, _animationBlend);
        }
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                if (_input._jump && _jumpTimeoutDelta <= 0.0f)
                {
                    ...
                    BallerInputNotifications.StartJumpAction.Invoke();
                }
